...
export const LoadingSpinner: React.FC = () => {
  return (
    <div className="flex items-start gap-3 justify-start">
        ...
        <div className="max-w-xl p-4 rounded-2xl bg-white shadow-sm border border-gray-200 rounded-bl-none">
            <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-600 rounded-full animate-pulse [animation-delay:-0.3s]"></div>
                <div className="w-2 h-2 bg-green-600 rounded-full animate-pulse [animation-delay:-0.15s]"></div>
